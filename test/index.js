...
test("isSupported tests", (t) => {
  t.ok(caniuse.isSupported("intersectionobserver", "chrome 69"), "intersectionobserver is supported on chrome 69 (despite a caniuse note)")
  t.notOk(caniuse.isSupported("intersectionobserver", "chrome 50"), "intersectionobserver is not supported on chrome 50")
  t.notOk(caniuse.isSupported("intersectionobserver", "safari 12.0.2"), "unknown browser version is reported as unsupported, not a false positive")
